    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1" style='margin-top:10px;'>
                <div  align='center'>
                <img src='../Adminstrators//images/shutterstock-661115842.jpg' height=50% width=50% align='center' style='margin-top:10px; border-raduis:50%;' >  
                </div>
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="p-t-20" style='padding-left:35%;' >
                            ...
                            <button class="btn btn--radius btn--green" type="submit" align='right'>Login</button>
                        </div>
                    </form>
                </div>
            </div>
